...
(async () => {
 ...
 try {
  ...
  await page.waitForFunction(async()=>{const c=await caches.open('webscanner-v16');return !!await c.match(new URL('js/vendor/zxing-wasm/3.1.2/zxing_reader.wasm',location.href).href)});
